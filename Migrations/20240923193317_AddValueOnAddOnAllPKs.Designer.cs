...
namespace LibraryManagementSystemEF.Migrations
{
    ...
    [Migration("20240923193317_AddValueOnAddOnAllPKs")]
    partial class AddValueOnAddOnAllPKs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagementSystemEF.Entities.BorrowedBook", b =>
                {
                    ...
                    b.Property<DateTime>("BorrowDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 23, 22, 33, 16, 500, DateTimeKind.Local).AddTicks(8225));
            ...
            modelBuilder.Entity("LibraryManagementSystemEF.Entities.Librarian", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ahmed Smith",
                            Password = "ahmed123",
                            DateOfEmployment = new DateTime(2024, 9, 23, 22, 33, 16, 502, DateTimeKind.Local).AddTicks(2132),
                            Salary = 5000
                        });
                });
            ...
            modelBuilder.Entity("LibraryManagementSystemEF.Entities.Member", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfMembership")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 23, 22, 33, 16, 503, DateTimeKind.Local).AddTicks(6802));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "John Doe",
                            Password = "john123",
                            DateOfMembership = new DateTime(2024, 9, 23, 22, 33, 16, 503, DateTimeKind.Local).AddTicks(7947),
                        ...
                        new
                        {
                            ...
                            Name = "Jane Doe",
                            Password = "jane123",
                            DateOfMembership = new DateTime(2024, 9, 23, 22, 33, 16, 503, DateTimeKind.Local).AddTicks(7961),
                            MembershipDuration = 30
                        });
                });
