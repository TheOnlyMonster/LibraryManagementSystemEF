...
namespace LibraryManagementSystemEF.Migrations
{
    ...
    [Migration("20240925134550_AppliedISoftDeletableForBooksTable")]
    partial class AppliedISoftDeletableForBooksTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagementSystemEF.Entities.BorrowedBook", b =>
                {
                    ...
                    b.Property<DateTime>("BorrowDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 25, 16, 45, 49, 993, DateTimeKind.Local).AddTicks(2740));
            ...
            modelBuilder.Entity("LibraryManagementSystemEF.Entities.Librarian", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ahmed Smith",
                            Password = "ahmed123",
                            DateOfEmployment = new DateTime(2024, 9, 25, 16, 45, 49, 994, DateTimeKind.Local).AddTicks(7679),
                            Salary = 5000
                        });
                });
            ...
            modelBuilder.Entity("LibraryManagementSystemEF.Entities.Member", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfMembership")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 16, 45, 49, 996, DateTimeKind.Local).AddTicks(3151));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "John Doe",
                            Password = "john123",
                            DateOfMembership = new DateTime(2024, 9, 25, 16, 45, 49, 996, DateTimeKind.Local).AddTicks(4591),
                        ...
                        new
                        {
                            ...
                            Name = "Jane Doe",
                            Password = "jane123",
                            DateOfMembership = new DateTime(2024, 9, 25, 16, 45, 49, 996, DateTimeKind.Local).AddTicks(4608),
                            MembershipDuration = 30
                        });
                });
